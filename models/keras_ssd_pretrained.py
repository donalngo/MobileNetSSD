...
def build_model(image_size,
    ...
    # SSD: VGG Conv4_3 equivalent (38x38)
    conv4_3 = base_model.get_layer('block_4_add').output
    #conv4_3_norm = L2Normalization(gamma_init=20, name='conv4_3_norm')(conv4_3)
    
    # SSD: VGG fc6 equivalent (19x19) This layer not used for SSD.
    fc6 = base_model.get_layer('block_12_add').output
    
    # SSD: VGG fc7 equivalent (19x19)
    fc7 = Conv2D(1024, (1, 1), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='fc7')(fc6)
    
    # SSD: VGG conv8_2 equivalent (10x10)
    ...
    # SSD: VGG conv9_2 equivalent (5x5)
    ...
    # SSD: VGG conv10_2 equivalent (3x3)
